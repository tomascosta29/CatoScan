"""
CIS Audit Check: SCTP Protocol Disabled

Checks if the SCTP protocol module is disabled (CIS 3.5.2).
"""
...
class SCTPProtocolCheck(BaseCheck):
    """Check if SCTP protocol module is disabled."""

    id = "net_proto_sctp"
    name = "SCTP Protocol Disabled"
    description = (
        "Verifies that the SCTP protocol module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the SCTP protocol disabled check.
