"""
CIS Audit Check: squashfs Filesystem Module Disabled

Checks if the squashfs filesystem module is disabled (CIS 1.1.1.6).
"""
...
class SquashfsModuleCheck(BaseCheck):
    """Check if squashfs filesystem module is disabled."""

    id = "fs_module_squashfs"
    name = "squashfs Filesystem Module Disabled"
    description = (
        "Verifies that the squashfs filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the squashfs module disabled check.
