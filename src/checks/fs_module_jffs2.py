"""
CIS Audit Check: jffs2 Filesystem Module Disabled

Checks if the jffs2 filesystem module is disabled (CIS 1.1.1.3).
"""
...
class Jffs2ModuleCheck(BaseCheck):
    """Check if jffs2 filesystem module is disabled."""

    id = "fs_module_jffs2"
    name = "jffs2 Filesystem Module Disabled"
    description = (
        "Verifies that the jffs2 filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the jffs2 module disabled check.
