"""
CIS Audit Check: RDS Protocol Disabled

Checks if the RDS protocol module is disabled (CIS 3.5.3).
"""
...
class RDSProtocolCheck(BaseCheck):
    """Check if RDS protocol module is disabled."""

    id = "net_proto_rds"
    name = "RDS Protocol Disabled"
    description = (
        "Verifies that the RDS (Reliable Datagram Sockets) protocol module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the RDS protocol disabled check.
