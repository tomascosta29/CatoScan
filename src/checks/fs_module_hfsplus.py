"""
CIS Audit Check: hfsplus Filesystem Module Disabled

Checks if the hfsplus filesystem module is disabled (CIS 1.1.1.5).
"""
...
class HfsplusModuleCheck(BaseCheck):
    """Check if hfsplus filesystem module is disabled."""

    id = "fs_module_hfsplus"
    name = "hfsplus Filesystem Module Disabled"
    description = (
        "Verifies that the hfsplus filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the hfsplus module disabled check.
