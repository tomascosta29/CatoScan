"""
CIS Audit Check: DCCP Protocol Disabled

Checks if the DCCP protocol module is disabled (CIS 3.5.1).
"""
...
class DCCPProtocolCheck(BaseCheck):
    """Check if DCCP protocol module is disabled."""

    id = "net_proto_dccp"
    name = "DCCP Protocol Disabled"
    description = (
        "Verifies that the DCCP protocol module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the DCCP protocol disabled check.
