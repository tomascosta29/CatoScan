"""
CIS Audit Check: cramfs Filesystem Module Disabled

Checks if the cramfs filesystem module is disabled (CIS 1.1.1.1).
"""
...
class CramfsModuleCheck(BaseCheck):
    """Check if cramfs filesystem module is disabled."""

    id = "fs_module_cramfs"
    name = "cramfs Filesystem Module Disabled"
    description = (
        "Verifies that the cramfs filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the cramfs module disabled check.
