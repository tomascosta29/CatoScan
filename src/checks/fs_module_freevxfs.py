"""
CIS Audit Check: freevxfs Filesystem Module Disabled

Checks if the freevxfs filesystem module is disabled (CIS 1.1.1.2).
"""
...
class FreevxfsModuleCheck(BaseCheck):
    """Check if freevxfs filesystem module is disabled."""

    id = "fs_module_freevxfs"
    name = "freevxfs Filesystem Module Disabled"
    description = (
        "Verifies that the freevxfs filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the freevxfs module disabled check.
