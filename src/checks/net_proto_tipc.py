"""
CIS Audit Check: TIPC Protocol Disabled

Checks if the TIPC protocol module is disabled (CIS 3.5.4).
"""
...
class TIPCProtocolCheck(BaseCheck):
    """Check if TIPC protocol module is disabled."""

    id = "net_proto_tipc"
    name = "TIPC Protocol Disabled"
    description = (
        "Verifies that the TIPC (Transparent Inter-Process Communication) protocol module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the TIPC protocol disabled check.
        ...
        if not module_loaded and has_install_true and has_blacklist:
            return CheckResult.passed_result(
                ...
                message=f"{self.MODULE_NAME} protocol module is disabled (not loaded, blacklisted in modprobe)",
        ...
        # Build remediation
        remediation_parts = [
            f"Disable {self.MODULE_NAME} protocol module:",
            "",
