"""
CIS Audit Check: hfs Filesystem Module Disabled

Checks if the hfs filesystem module is disabled (CIS 1.1.1.4).
"""
...
class HfsModuleCheck(BaseCheck):
    """Check if hfs filesystem module is disabled."""

    id = "fs_module_hfs"
    name = "hfs Filesystem Module Disabled"
    description = (
        "Verifies that the hfs filesystem module is disabled "
    ...
    def run(self) -> CheckResult:
        """Execute the hfs module disabled check.
